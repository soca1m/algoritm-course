...
# УРОК 1: ЩО ТАКЕ АЛГОРИТМ І ДЕКОМПОЗИЦІЯ ЗАВДАНЬ {#урок-1}
...
# УРОК 2: УМОВНА ЛОГІКА ТА ПРИЙНЯТТЯ РІШЕНЬ {#урок-2}
...
# УРОК 3: ЦИКЛИ ТА ПОВТОРЕННЯ {#урок-3}
...
# УРОК 4: ПОСЛІДОВНІСТЬ І ПАРАЛЕЛЬНІСТЬ {#урок-4}
...
# УРОК 5: ОБРОБКА ПОМИЛОК І ВИНЯТКІВ {#урок-5}
...
# УРОК 6: СТРУКТУРИ ДАНИХ У ПОВСЯКДЕННОМУ ЖИТТІ {#урок-6}
...
# УРОК 7: ПЛАНУВАННЯ СКЛАДНИХ ПРОЦЕСІВ {#урок-7}
...
# УРОК 8: ОСНОВИ ПРОМПТ ІНЖЕНЕРІЇ {#урок-8}
...
# УРОК 9: ПОБУДОВА WORKFLOW ДЛЯ АВТОМАТИЗАЦІЇ {#урок-9}
...
# УРОК 10: ПІДГОТОВКА ДО РОБОТИ З N8N {#урок-10}
